...
class monthlylb extends Command{

    constructor(client) {
        super(client, {
            name: "monthlylb",
            memberName: "monthlylb",
            aliases: ["monthlyleaderboards", "mlb"],
            group: "api",
            description: "View monthly top leaderboards",
            details: "A statistics command",
            examples: [`${client.config.prefix}monthlylb <tw:sg:dr:mm:sw>`],
            throttling: {
                duration: 5,
                usages: 1
            }
    ...
    runTWLeaderboards(message){
        ...
        request(`https://api.playhive.com/v0/game/monthly/wars`, function(error, response, body){
            try{
                ...
                let page1 = {
                    title: `Top ${infocheck2} Treasure Wars Wins`,
                    description: `Leaderboards are tracked monthly\n\`\`\`css${message1}\`\`\``
                }
                pMenu.addPage(page1);
    ...
    runSGLeaderboards(message){
        ...
        var pageNumber, infocheck2, infocheck3;
        var message1, message2, message3, message4, message5, message6, message7, message8, message9, message10;
        request(`https://api.playhive.com/v0/game/monthly/sg`, function(error, response, body){
            try{
                let data = JSON.parse(body);
                let message = '';
                pageNumber = 1;
                ...
                let page1 = {
                    title: `Top ${infocheck2} Survival Games Wins`,
                    description: `Leaderboards are tracked monthly\n\`\`\`css${message1}\`\`\``
                }
                pMenu.addPage(page1);
    ...
    runDRLeaderboards(message){
        ...
        var pageNumber, infocheck2, infocheck3;
        var message1, message2, message3, message4, message5, message6, message7, message8, message9, message10;
        request(`https://api.playhive.com/v0/game/monthly/dr`, function(error, response, body){
            try{
                let data = JSON.parse(body);
                let message = '';
                pageNumber = 1;
                ...
                let page1 = {
                    title: `Top ${infocheck2} Death Run Wins`,
                    description: `Leaderboards are tracked monthly\n\`\`\`css${message1}\`\`\``
                }
                pMenu.addPage(page1);
    ...
    runMMLeaderboards(message){
        ...
        request(`https://api.playhive.com/v0/game/monthly/dr`, function(error, response, body){
            try{
                ...
                let page1 = {
                    title: `Top ${infocheck2} Murder Mystery Wins`,
                    description: `Leaderboards are tracked monthly\n\`\`\`css${message1}\`\`\``
                }
                pMenu.addPage(page1);
    ...
    runSWLeaderboards(message){
        ...
        var pageNumber, infocheck2, infocheck3;
        var message1, message2, message3, message4, message5, message6, message7, message8, message9, message10;
        request(`https://api.playhive.com/v0/game/monthly/sky`, function(error, response, body){
            try{
                let data = JSON.parse(body);
                let message = '';
                pageNumber = 1;
                ...
                let page1 = {
                    title: `Top ${infocheck2} SkyWars Wins`,
                    description: `Leaderboards are tracked monthly\n\`\`\`css${message1}\`\`\``
                }
                pMenu.addPage(page1);
